...
- `git-release`: 自动化 GitHub/GitLab 发布流程（CHANGELOG + 语义化版本 + Release）
- `git-issue-solver`: 自动化处理 GitHub/GitLab Issue（列表/选择/分支/实现/提交）
- `git-issue-report`: 在 GitHub/GitLab 上创建格式规范的 Issue（优先使用仓库模板，支持 Bug 报告/功能请求/改进建议）
